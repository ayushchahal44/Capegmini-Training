...
public class AdminController {
	...
	@PreAuthorize("hasRole('ADMIN')")
	@Operation(summary = "Verify or reject document via document-service")
	public void verifyDocument(@PathVariable Long id, @Valid @RequestBody VerifyDocumentRequest request,
			@RequestHeader("Authorization") String auth) {
		adminService.verifyDocument(id, request, auth);
	}
